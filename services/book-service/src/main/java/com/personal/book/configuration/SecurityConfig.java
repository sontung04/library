    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) {
        return http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers(POST, "/api/books").hasRole(LIBRARIAN_ROLE)
                        .requestMatchers(PUT, "/api/books/{id}").hasRole(LIBRARIAN_ROLE)
                        .requestMatchers(DELETE, "/api/books/{id}").hasRole(LIBRARIAN_ROLE)
